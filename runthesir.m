...
vic=[2 3 4 5 9 21 24 45 51 61 93 105 230 271 335];
datemars=[7 8 9 10 11 13 14 15 16 17 19 20 21 22 23];
...
annotation('textbox', [.57 0.13 .08 .04], 'String', '7 Mars ');
...
hleg1=legend('S: Sains, Susceptibles','I: Infectés, Contagieux','R: Retirés (guéri ou décédé)','décès modélisés=0.01R','décès COVID 19, ARS');
set(hleg1,'Location','NorthWest');
annotation('textbox', [.62 0.13 .08 .06], 'String', '7 Mars ');
xlabel('temps (jours)','fontsize',14)
ylabel('nombre','fontsize',14)
...
set(hleg1,'Location','NorthWest');
annotation('textbox', [.66 0.13 .08 .06], 'String', '7 Mars ');
xlabel('temps (jours)','fontsize',14)
ylabel('nombre','fontsize',14)